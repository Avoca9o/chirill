...
import maskVideoFile from './resources/mask.mp4';
import videoFile from './resources/tramp.mp4';
...
const Video = () => {
  ...
  const aim = 20;
  const [count2, setCount2] = us eState(-1);
  const aim2 = 30;
    ...
    <div>
      ...
      {count2 == -1 ? (
        ...
        {count2 < aim2 ? (
          ...
          <div className="counters">
            <div>Набрано<br /> {count2}</div>
            <div>Цель<br /> {aim2}</div>
          </div>
        </div>
        ) : (
